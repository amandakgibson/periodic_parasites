...
```{r}
#################
# AMBIGUOUS DNA CONTENT - OFFSPRING
# OFFSPRING
...
boxplot(inf$freq~inf$sex*inf$treatment,
        ylim=c(0,1),ylab="", # ylab=proportion infected, with all females up in the corner
        lwd=2,cex.axis=1.5,names=c("diploid females","males","diploid females","males"),
        xlab="",outcex=1.5,
        col=c("#ca0020","#f4a582"))
abline(v=2.5,lty=3)
text(1.5,0.9,"Control",cex=2)
...
# SAMPLE SIZES GIVEN IN FIGURE 2A
```
...
# SAMPLE SIZES GIVEN IN FIGURE 2B
